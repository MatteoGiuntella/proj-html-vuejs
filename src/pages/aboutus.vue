...
export default {
  ...
  methods: {
    ...
    getCarousel () {
        setInterval(() => {
            if (this.counter < this.card.length -1) {
                this.counter++
            }
            else{
                this.counter = 0
    ...
    <div class="container">
      <div class="row my-5">
        <div class="col-6">
          ...
          <P
            >We love to inspire and guide you through any subject,<br />
            develop new skills or upgrade your educational background.</P
          >
        ...
        <div class="col-6">
          <div class="row justify-content-center align-items-center flex-wrap">
            <div
              v-for="(elem, i) in date"
              class="col-6 justify-content-center align-items-end"
            >
              <h1>{{ elem.number }}</h1>
              <h5>{{ elem.title }}</h5>
            </div>
        ...
        <div class="col-6">
          ...
          <div class="accordion" id="accordionExample">
              ...
              >
                <div class="accordion-body">
                  <span class="color_dark_gray">
                    ...
                    downloads. We know things aren't supposed to be devoured in
            ...
            <div class="accordion-item mb-4">
              ...
              >
                <div class="accordion-body">
                  Study for a number of courses at the same time is possible as
                  long as you can afford the fee and time for completing them in
                  the proper time. Learn at your own desired timeline and
                  timetable. Maximum up to 5 course at a time for a learner at
                  MaxCoach.
                </div>
              </div>
            </div>
            <div class="accordion-item mb-4">
              ...
              >
                <div class="accordion-body">
                  It's not just a normal thing to be able to build such a solid
                  online educational system like MaxCoach where your progress is
                  easily tracked and feedback is properly delivered. We promise
                  to keep improving our system for better stability and
                  flexibility.
                </div>
              </div>
            </div>
  ...
  <div class="container">
    <div class="row">
      <div class="col-12 text-xl-center">
        <span
          ><h1>Why Do People <span>*Hearts*</span> Us?</h1></span
        >
      </div>
    </div>
    <div class="row justify-content-center">
      <div class="col-4">
        <div class="card-img  ">
          <img class="carousel" :src="card[counter].img" alt="" />
        </div>
      </div>
      <div class="col-8">
        <p>{{ card[counter].content }}</p>
        <h4>{{ card[counter].name }}</h4>
        <h5>{{ card[counter].role }}</h5>
      </div>
    </div>
    <div class="row">
      <div class="col-12">
